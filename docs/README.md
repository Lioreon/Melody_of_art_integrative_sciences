# Documentación de Melody Motion

Esta carpeta conserva la memoria técnica, pedagógica y de producto del proyecto.
...
La rama `main` contiene el producto vivo. La historia del proyecto se conserva mediante Git y esta documentación; no se mantienen implementaciones obsoletas dentro del código vigente únicamente por razones históricas.
